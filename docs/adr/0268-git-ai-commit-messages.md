# ADR 0268: Tree review and AI commit messages in Git

- Status: Accepted
- Date: 2026-09-11
- Deciders: PI-Desktop core
- Related: D431, D432, ADR 0267, `07-plugins/03-plugin-api.md`,
  `04-ux/08-component-spec.md`, E2E-266
...
would weaken the boundary established by ADR 0267. Reusing the plugin-process
