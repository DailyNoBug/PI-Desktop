# ADR 0235: Managed SSH Password Authentication

- Status: Accepted for implementation
- Date: 2026-09-14
- Decision: D409
- Related: ADR 0234, `03-runtime/20-remote-ssh-desktop.md`,
  `04-ux/06-settings-ia.md`, `05-security/02-remote-control-security.md`

## Context

ADR 0234 delegated manual SSH authentication to the user's OpenSSH agent or an
