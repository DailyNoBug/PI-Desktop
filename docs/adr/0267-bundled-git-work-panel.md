# ADR 0267: Bundled Git work panel

- Status: Accepted (amended by ADR 0268 / D432)
- Date: 2026-09-11
- Deciders: PI-Desktop core
- Related: D246, D247, D248, D431, ADR 0104, ADR 0105, ADR 0170,
  `07-plugins/03-plugin-api.md`, `04-ux/08-component-spec.md`, E2E-265
...
1. **Git is a default bundled plugin.** `pi.git` contributes the `changes`
   ...
   *Amended by ADR 0268:* the plugin also declares `models.list` and
