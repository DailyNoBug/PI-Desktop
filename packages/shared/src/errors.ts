...
export const ErrorCodes = {
  ...
  SSH_NOT_AVAILABLE: "SSH_NOT_AVAILABLE",
  SSH_CONFIG_NOT_FOUND: "SSH_CONFIG_NOT_FOUND",
  SSH_HOST_NOT_FOUND: "SSH_HOST_NOT_FOUND",
  SSH_RESOLVE_FAILED: "SSH_RESOLVE_FAILED",
  ...
  SSH_CANCELED: "SSH_CANCELED",
  SSH_PORT_FORWARD_FAILED: "SSH_PORT_FORWARD_FAILED",
  REMOTE_OS_UNSUPPORTED: "REMOTE_OS_UNSUPPORTED",
  REMOTE_ARCH_UNSUPPORTED: "REMOTE_ARCH_UNSUPPORTED",
  REMOTE_SHELL_UNAVAILABLE: "REMOTE_SHELL_UNAVAILABLE",
  REMOTE_BOOTSTRAP_FAILED: "REMOTE_BOOTSTRAP_FAILED",
  REMOTE_DOWNLOAD_FAILED: "REMOTE_DOWNLOAD_FAILED",
  REMOTE_BUNDLE_MISSING: "REMOTE_BUNDLE_MISSING",
  REMOTE_CHECKSUM_MISMATCH: "REMOTE_CHECKSUM_MISMATCH",
  REMOTE_HOST_START_FAILED: "REMOTE_HOST_START_FAILED",
  REMOTE_HOST_UNAVAILABLE: "REMOTE_HOST_UNAVAILABLE",
  REMOTE_HOST_VERSION_INCOMPATIBLE: "REMOTE_HOST_VERSION_INCOMPATIBLE",
  REMOTE_PROTOCOL_MISMATCH: "REMOTE_PROTOCOL_MISMATCH",
  REMOTE_HANDSHAKE_FAILED: "REMOTE_HANDSHAKE_FAILED",
  REMOTE_PAIRING_FAILED: "REMOTE_PAIRING_FAILED",
  REMOTE_TOKEN_REVOKED: "REMOTE_TOKEN_REVOKED",
  REMOTE_PROJECT_NOT_FOUND: "REMOTE_PROJECT_NOT_FOUND",
  REMOTE_PROJECT_PERMISSION_DENIED: "REMOTE_PROJECT_PERMISSION_DENIED",
  REMOTE_PROJECT_INVALID_PATH: "REMOTE_PROJECT_INVALID_PATH",
  REMOTE_RECONNECT_EXHAUSTED: "REMOTE_RECONNECT_EXHAUSTED",
  /**
  ...
  PLAN_ALREADY_ACTIVE: "PLAN_ALREADY_ACTIVE",
   // Voice dictation (ADR: voice dictation, Phase 1).
   VOICE_NOT_CONFIGURED: "VOICE_NOT_CONFIGURED",
   VOICE_PAYLOAD_TOO_LARGE: "VOICE_PAYLOAD_TOO_LARGE",
