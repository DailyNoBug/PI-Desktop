...
export const es = {
  ...
  "chat": {
    ...
    "voice": {
      ...
      "cancelDictation": "Cancelar",
      "dismiss": "Descartar",
      "recording": "Grabando {{elapsed}}",
      "transcribing": "Transcribiendo…",
      "starting": "Solicitando micrófono…",
      "micDenied": "Permiso de micrófono denegado",
      "micUnavailable": "Micrófono no disponible",
      "notConfigured": "El dictado por voz no está configurado",
      "payloadTooLarge": "La grabación es demasiado grande para transcribir",
      "unauthorized": "El proveedor de transcripción rechazó la clave de API",
      "rateLimited": "El proveedor de transcripción está limitado",
      "timeout": "Tiempo de transcripción agotado",
      "cancelled": "Dictado cancelado",
      "busy": "Ya hay un dictado activo",
      "invalidAudio": "El audio grabado no es válido",
      "transcriptionFailed": "Error de transcripción",
      "unavailable": "Servicio de voz no disponible"
    },
  ...
  "remote": {
    ...
    "connection": "Conexión",
    "projectTitle": "Abrir proyecto remoto",
    "refresh": "Actualizar",
    "export": "Exportar",
    "import": "Importar",
    "importPlaceholder": "Pega la exportación de conexiones",
    ...
    "openProject": "Abrir proyecto remoto",
    "openingProject": "Abriendo…",
    "remoteTag": "Remoto",
    "noConnections": "No hay conexiones SSH",
    "attempt_one": "Intento {{count}}",
    "attempt_other": "Intentos {{count}}",
    "hostVersion": "Host {{version}}",
    "provider": "Proveedor",
    "providerDestination": "La credencial del proveedor se guardará en {{connection}}",
    "connect": "Conectar",
    "disconnect": "Desconectar",
    "cancelConnect": "Cancelar conexión",
    "sshOnly": "Solo SSH",
    "test": "Probar",
    "upgradeHost": "Actualizar Host",
    "syncProvider": "Sincronizar proveedor",
    "deleteProvider": "Eliminar proveedor remoto",
    "revokeDevice": "Revocar dispositivo",
    "deviceRevoked": "Token del dispositivo revocado",
    "relayTools": "Herramientas remotas",
    "relaySearch": "Buscar herramientas remotas",
    "relayEmpty": "Sin herramientas locales sin workspace",
    "relaySelected_one": "{{count}} seleccionada",
    "relaySelected_other": "{{count}} seleccionadas",
    "verifyTitle": "Verificar host remoto",
    "verifyMessage": "¿Confiar en {{target}}?",
    "verifyHost": "Confiar en host",
    "deepAddMessage": "¿Agregar {{name}}?",
    "deepOpenMessage": "¿Abrir {{path}}?",
    "deepLinkFailed": "Error del enlace remoto",
    "copyDiagnostics": "Copiar diagnóstico",
    "edit": "Editar",
    "remove": "Quitar",
    "removeConfirm": "¿Quitar la conexión {{name}}?",
    "addConnection": "Agregar conexión",
    "editConnection": "Editar conexión",
    "add": "Agregar",
    "source": "Origen de conexión",
    "sourceConfig": "Configuración OpenSSH",
    "sourceManaged": "Manual",
    "name": "Nombre",
    "alias": "Alias SSH",
    "hostname": "Host",
    "user": "Usuario",
    ...
    "hostPlaceholder": "host.com o user@host.com",
    "discoverAdd": "Hosts descubiertos",
    "connectRemoteDevice": "Conectarse a un dispositivo remoto por SSH",
    ...
    "selectIdentityFile": "Seleccionar archivo de identidad SSH",
    "state": {
      "disconnected": "Desconectado",
      "resolving": "Resolviendo",
      "connecting": "Conectando",
      "authenticating": "Autenticando",
      "bootstrapping": "Instalando Host",
      "starting_host": "Iniciando Host",
      "forwarding": "Reenviando puerto",
...
sklm: {
    ...
    "capabilityRemote": "Remoto: {{host}}",
    "capabilityLocal": "Local",
    "capabilityUnavailableRemote": "No disponible de forma remota",
    ...
    "voiceTitle": "Dictado por voz",
    voiceLocalDesc: "El dictado funciona por completo en este dispositivo con el plugin de voz local incluido. Descarga un modelo Whisper una vez y transcribe sin conexión, sin servicios en la nube.",
    voicePluginDisabled: "El plugin de voz local está desactivado. Actívalo en Ajustes → Plugins para usar el dictado.",
    voiceEngineMissing: "Esta compilación no incluye el motor de voz local. Reinstala la aplicación para habilitar el dictado.",
    voiceActionFailed: "Error en la acción de voz: {{message}}",
    voiceModelSize: "descarga de ≈{{size}} MB",
    voiceModelActive: "Activo",
    voiceModelDownload: "Descargar",
    voiceModelSetActive: "Usar",
    voiceModelRemove: "Eliminar",
    voiceDownloading: "Descargando…",
    voiceDownloadFailed: "Descarga fallida: {{message}}",
    "voiceLanguage": "Indicación de idioma",
    "voiceAutoSend": "Enviar transcripción automáticamente",
    "remove": "Quitar",
...
"importConfirm": "Las extensiones importadas se ejecutan en el proceso del agente con el mismo acceso que sus propias herramientas. Las habilidades declaradas pueden añadir instrucciones al agente y las dependencias declaradas se instalan con npm (scripts de instalación desactivados). ¿Continuar?",
    ...
    "tagLocal": "Local",
    "locationUnavailableRemote": "No disponible de forma remota",
    "tagBundled": "Incluido",
    ...
    "permissions": {
      ...
      "plugin.rpc": "Recibe solicitudes de gestión de la aplicación",
    ...
    "permissionHelp": {
      ...
      "plugin.rpc": "Recibe solicitudes de gestión de la interfaz de ajustes de la aplicación (por ejemplo, descargar los modelos de este plugin). Las solicitudes solo provienen de la ventana principal de PI-Desktop.",
