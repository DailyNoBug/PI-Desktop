...
export const tr = {
  ...
  tokenUsage: {
    ...
    loadFailed: "Kullanım yüklenemedi",
    retry: "Yeniden dene",
    chartSummary: "{{days}} gün · {{tokens}} token",
  },
  nav: {
  ...
  chat: {
    ...
    voice: {
      startDictation: "Dikteyi başlat",
      stopDictation: "Dikteyi durdur",
      cancelDictation: "İptal",
      dismiss: "Kapat",
      recording: "Kaydediliyor {{elapsed}}",
      transcribing: "Çevriliyor…",
      starting: "Mikrofon isteniyor…",
      micDenied: "Mikrofon izni reddedildi",
      micUnavailable: "Mikrofon kullanılamıyor",
      notConfigured: "Sesli dikte yapılandırılmadı",
      payloadTooLarge: "Kayıt transkripsiyon için çok büyük",
      unauthorized: "Transkripsiyon sağlayıcısı API anahtarını reddetti",
      rateLimited: "Transkripsiyon sağlayıcısı hız sınırına ulaştı",
      timeout: "Transkripsiyon zaman aşımına uğradı",
      cancelled: "Dikte iptal edildi",
      busy: "Başka bir dikte zaten etkin",
      invalidAudio: "Kaydedilen ses geçersiz",
      transcriptionFailed: "Transkripsiyon başarısız",
      unavailable: "Ses hizmeti kullanılamıyor",
    },
  },
  session: {
  ...
  remote: {
    connections: "SSH bağlantıları",
    connection: "Bağlantı",
    projectTitle: "Uzak projeyi aç",
    refresh: "Yenile",
    export: "Dışa aktar",
    import: "İçe aktar",
    importPlaceholder: "Bağlantı dışa aktarımını yapıştır",
    ...
    openProject: "Uzak projeyi aç",
    openingProject: "Açılıyor…",
    remoteTag: "Uzak",
    noConnections: "SSH bağlantısı yok",
    attempt_one: "Deneme {{count}}",
    attempt_other: "Deneme {{count}}",
    hostVersion: "Host {{version}}",
    provider: "Servis",
    providerDestination: "Servis kimlik bilgisi {{connection}} üzerine kaydedilecek",
    connect: "Bağlan",
    ...
    relayTools: "Araçları aktar",
    relaySearch: "Aktarılan araçları ara",
    "relayEmpty": "Workspace gerektirmeyen yerel araç yok",
    "relaySelected_one": "{{count}} seçildi",
    "relaySelected_other": "{{count}} seçildi",
    verifyTitle: "Uzak sunucuyu doğrula",
    verifyMessage: "{{target}} güvenilsin mi?",
    verifyHost: "Sunucuya güven",
    deepAddMessage: "{{name}} eklensin mi?",
    deepOpenMessage: "{{path}} açılsın mı?",
    deepLinkFailed: "Uzak bağlantı başarısız",
    copyDiagnostics: "Tanılamayı kopyala",
    edit: "Düzenle",
    remove: "Kaldır",
    removeConfirm: "{{name}} bağlantısı kaldırılsın mı?",
    addConnection: "Bağlantı ekle",
    editConnection: "Bağlantıyı düzenle",
    add: "Ekle",
    source: "Bağlantı kaynağı",
    sourceConfig: "OpenSSH yapılandırması",
    sourceManaged: "El ile",
    name: "Ad",
    alias: "SSH takma adı",
    hostname: "Sunucu",
    user: "Kullanıcı",
    ...
    state: {
      ...
      bootstrapping: "Host kuruluyor",
      starting_host: "Host başlatılıyor",
      forwarding: "Port yönlendiriliyor",
...
sklm: {
    ...
    capabilityLocal: "Yerel",
    capabilityUnavailableRemote: "Uzaktan kullanılamaz",
    ...
    voiceTitle: "Sesli dikte",
    voiceLocalDesc: "Yazıya dökme, yerleşik yerel ses eklentisiyle tamamen bu cihazda çalışır. Whisper modelini bir kez indirin, ardından çevrimdışı dönüştürün — bulut yok.",
    voicePluginDisabled: "Yerel ses eklentisi devre dışı. Dikteyi kullanmak için Ayarlar → Eklentiler bölümünden etkinleştirin.",
    voiceEngineMissing: "Bu derlemede yerel konuşma motoru yok. Dikteyi etkinleştirmek için uygulamayı yeniden yükleyin.",
    voiceActionFailed: "Ses işlemi başarısız: {{message}}",
    voiceModelSize: "≈{{size}} MB indirme",
    voiceModelActive: "Etkin",
    voiceModelDownload: "İndir",
    voiceModelSetActive: "Kullan",
    voiceModelRemove: "Sil",
    voiceDownloading: "İndiriliyor…",
    voiceDownloadFailed: "İndirme başarısız: {{message}}",
    voiceLanguage: "Dil ipucu",
    voiceAutoSend: "Transkripti otomatik gönder",
    remove: "Kaldır",
    apiStyle: "API biçimi",
...
importConfirm: "İçe aktarılan uzantılar ajan sürecinde, ajanın kendi araçlarıyla aynı erişimle çalışır. Bildirilen beceriler ajana talimatlar ekleyebilir ve bildirilen bağımlılıklar npm ile yüklenir (yükleme betikleri devre dışı). Devam edilsin mi?",
    ...
    tagLocal: "Yerel",
    locationUnavailableRemote: "Uzaktan kullanılamaz",
    tagBundled: "Yerleşik",
    ...
    permissions: {
      ...
      "plugin.rpc": "Uygulama yönetim isteklerini al",
    ...
    permissionHelp: {
      ...
      "plugin.rpc": "Uygulama ayarları arayüzünden yönetim istekleri alır (örneğin bu eklentinin modellerini indirmek). İstekler yalnızca PI-Desktop ana penceresinden gelir.",
