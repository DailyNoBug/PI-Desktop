...
export const fr = {
  ...
  "extensions": {
    "trusted": {
      "title": "Extensions de confiance",
      "description": "Code exécuté dans l'agent qui enregistre des outils, des commandes et des hooks.",
      "trustNotice": "Les extensions de confiance s'exécutent dans le processus de l'agent avec le même accès que ses propres outils. N'activez que du code auquel vous faites confiance. Rien n'est actif tant que vous ne l'activez pas.",
      "searchPlaceholder": "Rechercher des extensions",
      "rescan": "Rescanner",
      "addPath": "Ajouter un chemin",
      "remove": "Retirer",
      "userRoot": "Extensions utilisateur",
      "projectRoot": "Extensions du projet",
      "manualRoot": "Chemins ajoutés",
      "empty": "Aucune extension trouvée. Placez un fichier .ts ou .js dans votre dossier d'extensions ou ajoutez un chemin.",
      "noRegistrations": "Aucun outil ni commande enregistré pour l'instant",
      "loadsNextPrompt": "Les extensions activées se chargent au prochain message.",
      "toolCount": "{{count}} outils",
      "toolCount_one": "{{count}} outil",
      "toolCount_other": "{{count}} outils",
      "commandCount": "{{count}} commandes",
      "commandCount_one": "{{count}} commande",
      "commandCount_other": "{{count}} commandes",
      "diagnosticCount": "{{count}} diagnostics",
      "diagnosticCount_one": "{{count}} diagnostic",
      "diagnosticCount_other": "{{count}} diagnostics",
    ...
    "subagents": {
      ...
      "modelPickPlaceholder": "Choisir un modèle",
      "modelPickCustom": "Personnalisé (provider/model)…",
      "modelPickCustomHint": "Utiliser un modèle hors liste. Format : provider/model.",
      "modelPickEmpty": "Aucun modèle n’est encore disponible pour les sous-agents. Activez-en un dans Modèles.",
