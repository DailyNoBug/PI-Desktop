...
export const fr = {
  ...
  "chat": {
    ...
    "voice": {
      ...
      "cancelDictation": "Annuler",
      "dismiss": "Fermer",
      "recording": "Enregistrement {{elapsed}}",
      "transcribing": "Transcription…",
      "starting": "Demande du micro…",
      "micDenied": "Autorisation du micro refusée",
      "micUnavailable": "Micro indisponible",
      "notConfigured": "La dictée vocale n'est pas configurée",
      "payloadTooLarge": "L'enregistrement est trop volumineux pour être transcrit",
      "unauthorized": "Le fournisseur de transcription a refusé la clé d'API",
      "rateLimited": "Le fournisseur de transcription est limité",
      "timeout": "Délai de transcription dépassé",
      "cancelled": "Dictée annulée",
      "busy": "Une autre dictée est déjà active",
      "invalidAudio": "L'audio enregistré est invalide",
      "transcriptionFailed": "Échec de la transcription",
      "unavailable": "Service vocal indisponible"
    },
  ...
  "remote": {
    ...
    "projectTitle": "Ouvrir un projet distant",
    "refresh": "Actualiser",
    "export": "Exporter",
    "import": "Importer",
    "importPlaceholder": "Collez l'export de connexions",
    ...
    "terminalInput": "Entrée du terminal",
    "terminalDisconnected": "Terminal déconnecté",
    "path": "Chemin distant",
    "emptyDirectory": "Dossier vide",
    "gitRepository": "Dépôt Git",
    "openProject": "Ouvrir un projet distant",
    "openingProject": "Ouverture…",
    "remoteTag": "Distant",
    "noConnections": "Aucune connexion SSH",
    "attempt_one": "Tentative {{count}}",
    "attempt_other": "Tentatives {{count}}",
    "hostVersion": "Host {{version}}",
    "provider": "Fournisseur",
    "providerDestination": "L'identifiant du fournisseur sera enregistré sur {{connection}}",
    "connect": "Connecter",
    ...
    "relayTools": "Outils relayés",
    "relaySearch": "Rechercher des outils relayés",
    "relayEmpty": "Aucun outil local sans workspace",
    "relaySelected_one": "{{count}} sélectionné",
    "relaySelected_other": "{{count}} sélectionnés",
    "verifyTitle": "Vérifier l'hôte distant",
    "verifyMessage": "Faire confiance à {{target}} ?",
    "verifyHost": "Faire confiance à l'hôte",
    "deepAddMessage": "Ajouter {{name}} ?",
    "deepOpenMessage": "Ouvrir {{path}} ?",
    "deepLinkFailed": "Échec du lien distant",
    "copyDiagnostics": "Copier le diagnostic",
    "edit": "Modifier",
    "remove": "Retirer",
    "removeConfirm": "Supprimer la connexion {{name}} ?",
    "addConnection": "Ajouter une connexion",
    "editConnection": "Modifier la connexion",
    "add": "Ajouter",
    "source": "Source de connexion",
    "sourceConfig": "Configuration OpenSSH",
    "sourceManaged": "Manuel",
    "name": "Nom",
    "alias": "Alias SSH",
    "hostname": "Hôte",
    "user": "Utilisateur",
    ...
    "selectIdentityFile": "Sélectionner un fichier d'identité SSH",
    "state": {
      "disconnected": "Déconnecté",
      "resolving": "Résolution",
      "connecting": "Connexion",
      "authenticating": "Authentification",
      "bootstrapping": "Installation du Host",
      "starting_host": "Démarrage du Host",
      "forwarding": "Transfert de port",
...
sklm: {
    ...
    "capabilityUnavailableRemote": "Indisponible à distance",
    ...
    voiceLocalDesc: "La dictée s'exécute entièrement sur cet appareil via le plugin vocal local intégré. Téléchargez un modèle Whisper une fois, puis transposez hors ligne — sans service cloud.",
    voicePluginDisabled: "Le plugin vocal local est désactivé. Activez-le dans Paramètres → Plugins pour utiliser la dictée.",
    voiceEngineMissing: "Le moteur vocal local est absent de cette version. Réinstallez l'application pour activer la dictée.",
    voiceActionFailed: "Échec de l'action vocale : {{message}}",
    voiceModelSize: "≈{{size}} Mo à télécharger",
    voiceModelActive: "Actif",
    voiceModelDownload: "Télécharger",
    voiceModelSetActive: "Utiliser",
    voiceModelRemove: "Supprimer",
    voiceDownloading: "Téléchargement…",
    voiceDownloadFailed: "Échec du téléchargement : {{message}}",
    "voiceLanguage": "Indication de langue",
    "voiceAutoSend": "Envoyer automatiquement la transcription",
    "remove": "Retirer",
    "apiStyle": "Format API",
...
"importConfirm": "Les extensions importées s’exécutent dans le processus de l’agent avec les mêmes droits que ses outils. Les compétences déclarées peuvent ajouter des instructions à l’agent et les dépendances déclarées sont installées avec npm (scripts d’installation désactivés). Continuer ?",
    ...
    "tagLocal": "Local",
    "locationUnavailableRemote": "Indisponible à distance",
    "tagBundled": "Intégré",
    ...
    "permissions": {
      ...
      "plugin.rpc": "Reçoit les demandes de gestion de l'application",
    ...
    "permissionHelp": {
      ...
      "plugin.rpc": "Reçoit les demandes de gestion de l'interface des réglages de l'application (par exemple, télécharger les modèles de ce plugin). Les demandes proviennent uniquement de la fenêtre principale de PI-Desktop.",
