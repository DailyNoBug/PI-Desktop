export const en = {
  ...
  extensions: {
    "trusted": {
      ...
      "description": "Code that runs inside the agent and registers tools, commands, and hooks.",
      "trustNotice": "Trusted extensions run inside the agent process with the same access as the agent's own tools. Enable only code you trust. Nothing is enabled until you switch it on.",
      "searchPlaceholder": "Search extensions",
      "rescan": "Rescan",
      "addPath": "Add path",
      "remove": "Remove",
      "userRoot": "User extensions",
      "projectRoot": "Project extensions",
      "manualRoot": "Added paths",
      "empty": "No extensions found. Put a .ts or .js file in your extensions directory, or add a path.",
      "noRegistrations": "No tools or commands registered yet",
      "loadsNextPrompt": "Enabled extensions load on the next prompt.",
    ...
    subagents: {
      ...
      modelPickPlaceholder: "Choose a model",
      modelPickCustom: "Custom (provider/model)…",
      modelPickCustomHint: "Use a model not in the list. Format: provider/model.",
      modelPickEmpty: "No model is available for subagents yet. Enable one in Models.",
