export const en = {
  ...
  tokenUsage: {
    ...
    retry: "Retry",
    chartSummary: "{{days}} days · {{tokens}} tokens",
  },
  nav: {
  ...
  chat: {
    ...
    voice: {
      ...
      notConfigured: "Voice dictation is not configured",
      payloadTooLarge: "Recording is too large to transcribe",
      unauthorized: "Transcription provider rejected the API key",
      rateLimited: "Transcription provider is rate limited",
      timeout: "Transcription timed out",
      cancelled: "Dictation cancelled",
      busy: "Another dictation is already active",
      invalidAudio: "Recorded audio is invalid",
      transcriptionFailed: "Transcription failed",
      unavailable: "Voice service is unavailable",
    },
  },
  session: {
  ...
  remote: {
    ...
    projectTitle: "Open remote project",
    refresh: "Refresh",
    export: "Export",
    import: "Import",
    importPlaceholder: "Paste connection export",
    ...
    openProject: "Open remote project",
    ...
    provider: "Provider",
    providerDestination: "Provider credential will be saved to {{connection}}",
    connect: "Connect",
    ...
    relayTools: "Relay tools",
    relaySearch: "Search relay tools",
    relayEmpty: "No workspace-free local tools",
    relaySelected_one: "{{count}} selected",
    relaySelected_other: "{{count}} selected",
    verifyTitle: "Verify remote host",
    verifyMessage: "Trust {{target}}?",
    verifyHost: "Trust Host",
    deepAddMessage: "Add {{name}}?",
    deepOpenMessage: "Open {{path}}?",
    deepLinkFailed: "Remote link failed",
    copyDiagnostics: "Copy diagnostics",
    edit: "Edit",
    remove: "Remove",
    removeConfirm: "Remove connection {{name}}?",
    addConnection: "Add connection",
    editConnection: "Edit connection",
    add: "Add",
    source: "Connection source",
    sourceConfig: "OpenSSH config",
    ...
    state: {
      ...
      bootstrapping: "Installing Host",
      starting_host: "Starting Host",
      forwarding: "Forwarding port",
...
sklm: {
    ...
    capabilityUnavailableRemote: "Unavailable remotely",
    ...
    voiceLocalDesc: "Dictation runs entirely on this device with the bundled local-voice plugin. Download a Whisper model once, then transcribe offline — no cloud service.",
    ...
    voicePluginDisabled: "The local-voice plugin is disabled. Enable it in Settings → Plugins to use dictation.",
    voiceEngineMissing: "The local speech engine is not installed in this build. Reinstall the application to enable dictation.",
    voiceActionFailed: "Voice action failed: {{message}}",
    voiceModelSize: "≈{{size}} MB download",
    voiceModelActive: "Active",
    voiceModelDownload: "Download",
    voiceModelSetActive: "Use",
    voiceModelRemove: "Delete",
    voiceDownloading: "Downloading…",
    voiceDownloadFailed: "Download failed: {{message}}",
    ...
    voiceLanguage: "Language hint",
    voiceAutoSend: "Auto-send transcript",
    remove: "Remove",
    apiStyle: "API format",
...
importConfirm: "Imported extensions run inside the agent process with the same access as the agent's own tools. Declared skills can add instructions to the agent, and declared dependencies are installed with npm (install scripts disabled). Continue?",
    ...
    tagLocal: "Local",
    locationUnavailableRemote: "Unavailable remotely",
    tagBundled: "Bundled",
    ...
    permissions: {
      ...
      "plugin.rpc": "Receive app management requests",
    ...
    permissionHelp: {
      ...
      "speech.adapter.register": "Can provide a speech-to-text or text-to-speech protocol that the app's voice features may route through.",
      "plugin.rpc": "Receives management requests from the app's own settings UI (for example, downloading this plugin's models). Requests come only from PI-Desktop's main window.",
