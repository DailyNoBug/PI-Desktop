...
export const zhTW = {
  ...
  chat: {
    ...
    voice: {
      ...
      cancelDictation: "取消",
      dismiss: "關閉",
      recording: "正在錄音 {{elapsed}}",
      transcribing: "正在轉寫…",
      starting: "正在請求麥克風…",
      micDenied: "麥克風權限被拒絕",
      micUnavailable: "麥克風無法使用",
      notConfigured: "語音聽寫尚未設定",
      payloadTooLarge: "錄音過大,無法轉寫",
      unauthorized: "轉寫服務拒絕了 API 金鑰",
      rateLimited: "轉寫服務已限流",
      timeout: "轉寫逾時",
      cancelled: "聽寫已取消",
      busy: "已有聽寫正在進行",
  ...
  remote: {
    ...
    openingProject: "正在開啟…",
    remoteTag: "遠端",
    noConnections: "暫無 SSH 連線",
    attempt_one: "第 {{count}} 次嘗試",
    attempt_other: "第 {{count}} 次嘗試",
    hostVersion: "Host {{version}}",
    provider: "模型服務",
    providerDestination: "模型服務憑證將儲存到 {{connection}}",
    connect: "連線",
    disconnect: "中斷",
    cancelConnect: "取消連線",
    sshOnly: "純 SSH",
    ...
    relayTools: "中繼工具",
    relaySearch: "搜尋中繼工具",
    relayEmpty: "暫無無 workspace 相依的本機工具",
    relaySelected_one: "已選擇 {{count}} 個",
    relaySelected_other: "已選擇 {{count}} 個",
    verifyTitle: "驗證遠端主機",
    verifyMessage: "信任 {{target}} 嗎？",
    verifyHost: "信任主機",
    deepAddMessage: "新增 {{name}} 嗎？",
    deepOpenMessage: "開啟 {{path}} 嗎？",
    deepLinkFailed: "遠端連結失敗",
    copyDiagnostics: "複製診斷",
    edit: "編輯",
    remove: "移除",
    removeConfirm: "確定移除連線 {{name}} 嗎？",
    addConnection: "新增連線",
    editConnection: "編輯連線",
    add: "新增",
    source: "連線來源",
    sourceConfig: "OpenSSH 設定",
    sourceManaged: "手動",
    name: "名稱",
    alias: "SSH 別名",
    hostname: "主機名稱",
    ...
    state: {
      ...
      connecting: "正在連線",
      authenticating: "正在認證",
      bootstrapping: "正在安裝 Host",
      starting_host: "正在啟動 Host",
      forwarding: "正在轉發連接埠",
      handshaking: "正在交握",
      connected: "已連線",
      reconnecting: "正在重連",
...
sklm: {
    ...
    capabilityLocal: "本地",
    capabilityUnavailableRemote: "遠端不可用",
    ...
    voiceTitle: "語音聽寫",
    voiceLocalDesc: "聽寫完全在本機執行：使用內建的本地語音外掛，下載一次 Whisper 模型後即可離線轉寫，不經任何雲端服務。",
    voicePluginDisabled: "本地語音外掛已停用。請到 設定 → 外掛 中啟用後再使用聽寫。",
    voiceEngineMissing: "此建置缺少本地語音引擎，請重新安裝應用程式以啟用聽寫。",
    voiceActionFailed: "語音操作失敗：{{message}}",
    voiceModelSize: "下載約 {{size}} MB",
    voiceModelActive: "使用中",
    voiceModelDownload: "下載",
    voiceModelSetActive: "啟用",
    voiceModelRemove: "刪除",
    voiceDownloading: "下載中…",
    voiceDownloadFailed: "下載失敗：{{message}}",
    voiceLanguage: "語言提示",
    voiceAutoSend: "自動傳送轉寫文字",
    remove: "移除",
    apiStyle: "介面格式",
  ...
  plugins: {
    ...
    groupDisabled: "已關閉",
    tagLocal: "本地",
    locationUnavailableRemote: "遠端不可用",
    tagBundled: "內建",
    rowActions: "{{name}} 的操作",
    details: "詳情",
    ...
    permissionHelp: {
      ...
      "plugin.rpc": "接收來自應用程式設定介面的管理請求（例如下載本外掛的模型）。請求僅來自 PI-Desktop 主視窗。",
