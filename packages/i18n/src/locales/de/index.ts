...
export const de = {
  ...
  "chat": {
    ...
    "voice": {
      ...
      "cancelDictation": "Abbrechen",
      "dismiss": "Schließen",
      "recording": "Aufnahme läuft {{elapsed}}",
      "transcribing": "Transkribiere…",
      "starting": "Mikrofon wird angefragt…",
      "micDenied": "Mikrofonzugriff verweigert",
      "micUnavailable": "Mikrofon nicht verfügbar",
      "notConfigured": "Sprachdiktat ist nicht konfiguriert",
      "payloadTooLarge": "Aufnahme ist zu groß zum Transkribieren",
      "unauthorized": "Transcriptionsanbieter hat den API-Schlüssel abgelehnt",
      "rateLimited": "Transcriptionsanbieter ist ratebegrenzt",
      "timeout": "Transkription mit Zeitüberschreitung abgebrochen",
      "cancelled": "Diktat abgebrochen",
      "busy": "Ein anderes Diktat ist bereits aktiv",
      "invalidAudio": "Aufgenommene Audiodaten sind ungültig",
      "transcriptionFailed": "Transkription fehlgeschlagen",
      "unavailable": "Sprachdienst nicht verfügbar"
    },
  ...
  "remote": {
    "connections": "SSH-Verbindungen",
    "connection": "Verbindung",
    "projectTitle": "Remote-Projekt öffnen",
    "refresh": "Aktualisieren",
    "export": "Exportieren",
    "import": "Importieren",
    "importPlaceholder": "Verbindungsexport einfügen",
    ...
    "openProject": "Remote-Projekt öffnen",
    "openingProject": "Wird geöffnet…",
    "remoteTag": "Remote",
    "noConnections": "Keine SSH-Verbindungen",
    "attempt_one": "Versuch {{count}}",
    "attempt_other": "Versuch {{count}}",
    "hostVersion": "Host {{version}}",
    "provider": "Anbieter",
    "providerDestination": "Anbieterberechtigung wird auf {{connection}} gespeichert",
    "connect": "Verbinden",
    "disconnect": "Trennen",
    ...
    "relayTools": "Tools weiterleiten",
    "relaySearch": "Weitergeleitete Tools suchen",
    "relayEmpty": "Keine workspace-freien lokalen Tools",
    "relaySelected_one": "{{count}} ausgewählt",
    "relaySelected_other": "{{count}} ausgewählt",
    "verifyTitle": "Remote-Host überprüfen",
    "verifyMessage": "{{target}} vertrauen?",
    "verifyHost": "Host vertrauen",
    "deepAddMessage": "{{name}} hinzufügen?",
    "deepOpenMessage": "{{path}} öffnen?",
    "deepLinkFailed": "Remote-Link fehlgeschlagen",
    "copyDiagnostics": "Diagnose kopieren",
    "edit": "Bearbeiten",
    "remove": "Entfernen",
    "removeConfirm": "Verbindung {{name}} entfernen?",
    "addConnection": "Verbindung hinzufügen",
    "editConnection": "Verbindung bearbeiten",
    "add": "Hinzufügen",
    "source": "Verbindungsquelle",
    "sourceConfig": "OpenSSH-Konfiguration",
    "sourceManaged": "Manuell",
    "name": "Name",
    "alias": "SSH-Alias",
    "hostname": "Hostname",
    "user": "Benutzer",
    ...
    "hostPlaceholder": "host.com oder user@host.com",
    "discoverAdd": "Gefundene Hosts",
    "connectRemoteDevice": "Über SSH mit einem Remote-Gerät verbinden",
    ...
    "state": {
      ...
      "bootstrapping": "Host wird installiert",
      "starting_host": "Host wird gestartet",
      "forwarding": "Portweiterleitung",
      "handshaking": "Handshake",
      "connected": "Verbunden",
      "reconnecting": "Neue Verbindung wird hergestellt",
...
sklm: {
    ...
    "capabilityLocal": "Lokal",
    "capabilityUnavailableRemote": "Remote nicht verfügbar",
    ...
    voiceLocalDesc: "Diktat läuft komplett auf diesem Gerät über das mitgelieferte Local-Voice-Plugin. Einmal ein Whisper-Modell laden, dann offline transkribieren – ohne Cloud.",
    voicePluginDisabled: "Das Local-Voice-Plugin ist deaktiviert. Aktiviere es unter Einstellungen → Plugins, um Diktat zu nutzen.",
    voiceEngineMissing: "In diesem Build fehlt die lokale Sprach-Engine. Installiere die App neu, um Diktat zu nutzen.",
    voiceActionFailed: "Sprachaktion fehlgeschlagen: {{message}}",
    voiceModelSize: "ca. {{size}} MB Download",
    voiceModelActive: "Aktiv",
    voiceModelDownload: "Herunterladen",
    voiceModelSetActive: "Verwenden",
    voiceModelRemove: "Löschen",
    voiceDownloading: "Wird geladen…",
    voiceDownloadFailed: "Download fehlgeschlagen: {{message}}",
    "voiceLanguage": "Sprachhinweis",
    "voiceAutoSend": "Transkript automatisch senden",
    "remove": "Entfernen",
    "apiStyle": "API-Format",
...
"importConfirm": "Importierte Erweiterungen laufen im Agentenprozess mit denselben Rechten wie die Tools des Agenten. Deklarierte Skills können dem Agenten Anweisungen hinzufügen, und deklarierte Abhängigkeiten werden mit npm installiert (Installationsskripte deaktiviert). Fortfahren?",
    ...
    "tagLocal": "Lokal",
    "locationUnavailableRemote": "Remote nicht verfügbar",
    ...
    "permissions": {
      ...
      "plugin.rpc": "App-verwaltete Anfragen empfangen",
    ...
    "permissionHelp": {
      ...
      "plugin.rpc": "Empfängt Verwaltungsanfragen der App-Einstellungen (z. B. das Herunterladen der Plugin-Modelle). Anfragen kommen ausschließlich vom Hauptfenster von PI-Desktop.",
