...
export const de = {
  ...
  "settings": {
    ...
    "nav": {
      ...
      "trustedExtensions": "Erweiterungen",
  ...
  "extensions": {
    "trusted": {
      "title": "Vertrauenswürdige Erweiterungen",
      "description": "Code, der im Agenten läuft und Tools, Befehle und Hooks registriert.",
      "trustNotice": "Vertrauenswürdige Erweiterungen laufen im Agentenprozess mit denselben Rechten wie die Tools des Agenten. Aktiviere nur Code, dem du vertraust. Nichts ist aktiv, bis du es einschaltest.",
      "searchPlaceholder": "Erweiterungen durchsuchen",
      "rescan": "Neu scannen",
      "addPath": "Pfad hinzufügen",
      "remove": "Entfernen",
      "userRoot": "Benutzererweiterungen",
      "projectRoot": "Projekterweiterungen",
      "manualRoot": "Hinzugefügte Pfade",
      "empty": "Keine Erweiterungen gefunden. Lege eine .ts- oder .js-Datei im Erweiterungsordner ab oder füge einen Pfad hinzu.",
      "noRegistrations": "Noch keine Tools oder Befehle registriert",
      "loadsNextPrompt": "Aktivierte Erweiterungen werden beim nächsten Prompt geladen.",
      "toolCount": "{{count}} Tools",
      "toolCount_one": "{{count}} Tool",
      "toolCount_other": "{{count}} Tools",
      "commandCount": "{{count}} Befehle",
      "commandCount_one": "{{count}} Befehl",
      "commandCount_other": "{{count}} Befehle",
      "diagnosticCount": "{{count}} Diagnosen",
      "diagnosticCount_one": "{{count}} Diagnose",
      "diagnosticCount_other": "{{count}} Diagnosen",
    ...
    "subagents": {
      ...
      "modelPickPlaceholder": "Modell wählen",
      "modelPickCustom": "Benutzerdefiniert (Anbieter/Modell)…",
      "modelPickCustomHint": "Ein nicht gelistetes Modell verwenden. Format: Anbieter/Modell.",
      "modelPickEmpty": "Noch kein Modell für Subagenten verfügbar. Aktivieren Sie eines in Modelle.",
