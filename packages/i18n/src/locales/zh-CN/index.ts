...
export const zhCN = {
  ...
  extensions: {
    "trusted": {
      "title": "受信任扩展",
      "description": "在 agent 内部运行并注册工具、命令和 hooks 的代码。",
      "trustNotice": "受信任扩展在 agent 进程内运行，拥有与 agent 自身工具相同的权限。只启用你信任的代码。未手动打开前不会启用任何扩展。",
      ...
      "projectRoot": "项目扩展",
      "manualRoot": "已添加的路径",
      "empty": "未找到扩展。把 .ts 或 .js 文件放进扩展目录，或添加一个路径。",
      "noRegistrations": "尚未注册工具或命令",
      "loadsNextPrompt": "已启用的扩展会在下一次发送提示时加载。",
      "toolCount": "{{count}} 个工具",
      "toolCount_one": "{{count}} 个工具",
      "toolCount_other": "{{count}} 个工具",
      "commandCount": "{{count}} 个命令",
      "commandCount_one": "{{count}} 个命令",
      "commandCount_other": "{{count}} 个命令",
      "diagnosticCount": "{{count}} 条诊断",
      "diagnosticCount_one": "{{count}} 条诊断",
      "diagnosticCount_other": "{{count}} 条诊断",
      "diagnostics": "诊断",
    ...
    subagents: {
      ...
      modelPickCustom: "自定义（provider/model）…",
      modelPickCustomHint: "使用列表外的模型。格式：provider/model。",
      modelPickEmpty: "尚无可用于子智能体的模型，请在模型设置中启用一个。",
