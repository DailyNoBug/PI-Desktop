...
export const zhCN = {
  ...
  tokenUsage: {
    ...
    loadFailed: "无法加载用量",
    retry: "重试",
    chartSummary: "{{days}} 天 · {{tokens}} tokens",
  },
  nav: {
    pinnedSessions: "置顶",
    home: "首页",
  ...
  chat: {
    ...
    webSearchUnsupported: "当前线路不支持联网搜索",
    webSearchRunning: "正在联网搜索…",
    webSearchSources: "{{count}} 个来源",
    webSearchSources_other: "{{count}} 个来源",
    webSearchQuery: "搜索了 {{query}}",
    webSearchShow: "显示联网搜索",
    webSearchHide: "隐藏联网搜索",
    webSearchEmpty: "这次搜索没有返回来源。",
    webSearchSummary: "已搜索 {{searchCount}} 次 · {{sourceCount}} 个来源",
    webSearchMore: "查看其余 {{count}} 个来源",
    webSearchCitationPrev: "上一个引用来源",
    webSearchCitationNext: "下一个引用来源",
    untitledTask: "新建任务",
    voice: {
      startDictation: "开始听写",
      stopDictation: "停止听写",
      cancelDictation: "取消",
      dismiss: "关闭",
      recording: "正在录音 {{elapsed}}",
      transcribing: "正在转写…",
      starting: "正在请求麦克风…",
      micDenied: "麦克风权限被拒绝",
      micUnavailable: "麦克风不可用",
      notConfigured: "语音听写尚未配置",
      payloadTooLarge: "录音过大,无法转写",
      unauthorized: "转写服务拒绝了 API 密钥",
      rateLimited: "转写服务已限流",
      timeout: "转写超时",
      cancelled: "听写已取消",
      busy: "已有听写正在进行",
  ...
  remote: {
    ...
    attempt_one: "第 {{count}} 次尝试",
    attempt_other: "第 {{count}} 次尝试",
    hostVersion: "Host {{version}}",
    provider: "模型服务",
    providerDestination: "模型服务凭据将保存到 {{connection}}",
    connect: "连接",
    disconnect: "断开",
    cancelConnect: "取消连接",
    sshOnly: "纯 SSH",
    ...
    relayTools: "中继工具",
    relaySearch: "搜索中继工具",
    relayEmpty: "暂无无 workspace 依赖的本地工具",
    relaySelected_one: "已选择 {{count}} 个",
    relaySelected_other: "已选择 {{count}} 个",
    verifyTitle: "验证远程主机",
    verifyMessage: "信任 {{target}} 吗？",
    verifyHost: "信任主机",
    deepAddMessage: "添加 {{name}} 吗？",
    deepOpenMessage: "打开 {{path}} 吗？",
    deepLinkFailed: "远程链接失败",
    copyDiagnostics: "复制诊断",
    edit: "编辑",
    remove: "移除",
    removeConfirm: "确定移除连接 {{name}} 吗？",
    addConnection: "添加连接",
    editConnection: "编辑连接",
    add: "添加",
    source: "连接来源",
    sourceConfig: "OpenSSH 配置",
    sourceManaged: "手动",
    name: "名称",
    alias: "SSH 别名",
    hostname: "主机名",
...
sklm: {
    ...
    capabilityRemote: "远程：{{host}}",
    capabilityLocal: "本地",
    capabilityUnavailableRemote: "远程不可用",
    ...
    defaultsTitle: "默认项",
    voiceTitle: "语音听写",
    voiceLocalDesc: "听写完全在本机运行：使用内置的本地语音插件，下载一次 Whisper 模型后即可离线转写，不经任何云服务。",
    voicePluginDisabled: "本地语音插件已停用。请到 设置 → 插件 中启用后再使用听写。",
    voiceEngineMissing: "此构建缺少本地语音引擎，请重新安装应用以启用听写。",
    voiceActionFailed: "语音操作失败：{{message}}",
    voiceModelSize: "下载约 {{size}} MB",
    voiceModelActive: "使用中",
    voiceModelDownload: "下载",
    voiceModelSetActive: "启用",
    voiceModelRemove: "删除",
    voiceDownloading: "下载中…",
    voiceDownloadFailed: "下载失败：{{message}}",
    defaultModel: "默认模型",
  ...
  plugins: {
    ...
    groupDisabled: "已关闭",
    tagLocal: "本地",
    locationUnavailableRemote: "远程不可用",
    tagBundled: "内置",
    rowActions: "{{name}} 的操作",
    details: "详情",
    ...
    permissionHelp: {
      ...
      "speech.adapter.register": "可以提供语音转文字或文字转语音协议，应用的语音功能经由它们工作。",
      "plugin.rpc": "接收来自应用设置界面的管理请求（例如下载本插件的模型）。请求仅来自 PI-Desktop 主窗口。",
