...
export const ko = {
  ...
  tokenUsage: {
    ...
    cacheWrite: "캐시 쓰기",
    reasoning: "추론",
    loadFailed: "사용량을 불러올 수 없습니다",
    retry: "다시 시도",
    chartSummary: "{{days}}일 · {{tokens}} 토큰",
  },
  nav: {
    "pinnedSessions": "고정됨",
    home: "홈",
  ...
  chat: {
    ...
    voice: {
      ...
      cancelDictation: "취소",
      dismiss: "닫기",
      recording: "녹음 중 {{elapsed}}",
      transcribing: "변환 중…",
      starting: "마이크 권한 요청 중…",
      micDenied: "마이크 권한이 거부되었습니다",
      micUnavailable: "마이크를 사용할 수 없습니다",
      notConfigured: "음성 받아쓰기가 구성되지 않았습니다",
      payloadTooLarge: "녹음이 너무 커서 변환할 수 없습니다",
      unauthorized: "변환 제공자가 API 키를 거부했습니다",
      rateLimited: "변환 제공자가 요청을 제한하고 있습니다",
      timeout: "변환 시간이 초과되었습니다",
      cancelled: "받아쓰기가 취소되었습니다",
      busy: "다른 받아쓰기가 이미 진행 중입니다",
      invalidAudio: "녹음된 오디오가 잘못되었습니다",
      transcriptionFailed: "변환에 실패했습니다",
      unavailable: "음성 서비스를 사용할 수 없습니다",
    },
  },
  session: {
  ...
  remote: {
    connections: "SSH 연결",
    connection: "연결",
    projectTitle: "원격 프로젝트 열기",
    refresh: "새로 고침",
    export: "내보내기",
    import: "가져오기",
    importPlaceholder: "연결 내보내기 붙여넣기",
    ...
    openProject: "원격 프로젝트 열기",
    openingProject: "여는 중…",
    remoteTag: "원격",
    noConnections: "SSH 연결 없음",
    attempt_one: "{{count}}회 시도",
    attempt_other: "{{count}}회 시도",
    hostVersion: "Host {{version}}",
    provider: "프로바이더",
    providerDestination: "프로바이더 자격 증명은 {{connection}}에 저장됩니다",
    connect: "연결",
    disconnect: "연결 해제",
    cancelConnect: "연결 취소",
    sshOnly: "SSH 전용",
    ...
    relayTools: "도구 중계",
    relaySearch: "중계 도구 검색",
    relayEmpty: "워크스페이스 없이 사용할 수 있는 로컬 도구가 없습니다",
    relaySelected_one: "{{count}}개 선택됨",
    relaySelected_other: "{{count}}개 선택됨",
    verifyTitle: "원격 호스트 확인",
    verifyMessage: "{{target}}을(를) 신뢰할까요?",
    verifyHost: "호스트 신뢰",
    deepAddMessage: "{{name}}을(를) 추가할까요?",
    deepOpenMessage: "{{path}}을(를) 열까요?",
    deepLinkFailed: "원격 링크 실패",
    copyDiagnostics: "진단 복사",
    edit: "편집",
    remove: "제거",
    removeConfirm: "연결 {{name}}을(를) 제거할까요?",
    addConnection: "연결 추가",
    editConnection: "연결 편집",
    add: "추가",
    source: "연결 원본",
    sourceConfig: "OpenSSH 설정",
    sourceManaged: "수동",
    name: "이름",
    alias: "SSH 별칭",
    hostname: "호스트",
    ...
    state: {
      ...
      connecting: "연결 중",
      authenticating: "인증 중",
      bootstrapping: "Host 설치 중",
      starting_host: "Host 시작 중",
      forwarding: "포트 포워딩 중",
      handshaking: "핸드셰이크 중",
      connected: "연결됨",
...
sklm: {
    ...
    capabilityLocal: "로컬",
    capabilityUnavailableRemote: "원격에서 사용할 수 없음",
    ...
    voiceTitle: "음성 받아쓰기",
    voiceLocalDesc: "받아쓰기는 내장된 로컬 음성 플러그인으로 이 기기에서 완전히 실행됩니다. Whisper 모델을 한 번만 다운로드하면 클라우드 없이 오프라인으로 전사할 수 있습니다.",
    voicePluginDisabled: "로컬 음성 플러그인이 비활성화되어 있습니다. 설정 → 플러그인에서 활성화하세요.",
    voiceEngineMissing: "이 빌드에는 로컬 음성 엔진이 없습니다. 받아쓰기를 사용하려면 앱을 다시 설치하세요.",
    voiceActionFailed: "음성 작업 실패: {{message}}",
    voiceModelSize: "약 {{size}} MB 다운로드",
    voiceModelActive: "사용 중",
    voiceModelDownload: "다운로드",
    voiceModelSetActive: "사용",
    voiceModelRemove: "삭제",
    voiceDownloading: "다운로드 중…",
    voiceDownloadFailed: "다운로드 실패: {{message}}",
    voiceLanguage: "언어 힌트",
    voiceAutoSend: "변환 텍스트 자동 전송",
    remove: "제거",
    apiStyle: "API 형식",
...
importConfirm: "가져온 확장은 에이전트 프로세스 안에서 에이전트 자체 도구와 같은 권한으로 실행됩니다. 선언된 스킬은 에이전트에 지침을 추가할 수 있고, 선언된 의존성은 npm으로 설치됩니다(설치 스크립트 비활성화). 계속할까요?",
    ...
    groupDisabled: "꺼짐",
    tagLocal: "로컬",
    locationUnavailableRemote: "원격에서 사용할 수 없음",
    tagBundled: "내장",
    rowActions: "{{name}} 작업",
    details: "세부 정보",
    ...
    permissionHelp: {
      ...
      "plugin.rpc": "앱 설정 화면의 관리 요청(예: 이 플러그인 모델 다운로드)을 받습니다. 요청은 PI-Desktop 메인 창에서만 전송됩니다.",
