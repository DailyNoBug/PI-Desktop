...
import { ErrorCodes, IPC, type ActivationScope, type AgentCapabilityMove, type AgentCapabilityQuery, type UserSkillInput, type UserSkillRecord, type UserSubagentRecord } from "@pi-desktop/shared";
...
export function registerSkillsIpc({
  ...
  */
  ...
  // Remote skills live on the SSH connection bound to the project. The
