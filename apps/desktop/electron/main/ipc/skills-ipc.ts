...
import { ErrorCodes, IPC, type ActivationScope, type AgentCapabilityQuery, type UserSkillInput, type UserSkillRecord, type UserSubagentRecord } from "@pi-desktop/shared";
