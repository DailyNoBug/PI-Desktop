...
export function ComposerToolbar({
  ...
  // A remote (SSH) workspace has no local filesystem to pick files from, so
  // the attach affordance is withheld instead of failing at click time.
  const isRemoteWorkspace = isRemoteProjectPath(workspacePath);
  return (
